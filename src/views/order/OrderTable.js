...
const headCells = [
  { id: 'total', numeric: true, disablePadding: true, label: 'Amount' },
  { id: 'name', numeric: false, disablePadding: true, label: 'Name' },
  { id: 'method', numeric: false, disablePadding: true, label: 'Method' },
  { id: 'ID', numeric: true, disablePadding: true, label: 'Payment ID' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left"><Button onClick={()=>handleClickOpen(row)} size='small' variant="outlined">Action</Button></TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
